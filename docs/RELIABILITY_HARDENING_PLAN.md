...
anchor. Until the reconciled exact head has a fresh accepted receipt, T2 is
**IMPLEMENTED CANDIDATE / NOT QUALIFIED**. Native platform and crash/power-loss
qualification remain pending and are not represented as PASS.
